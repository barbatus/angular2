      ...
      moduleSymbols.forEach(function(tsModule) {
        ...
        tsModule.exportArray.forEach(function(moduleExport) {
          ...
          if (moduleExport.flags & ts.SymbolFlags.Alias) {
            ...
            moduleExport.resolvedSymbol.declarations = moduleExport.resolvedSymbol.declarations.length ? moduleExport.resolvedSymbol.declarations : moduleExport.declarations;
          }
        });
      });
